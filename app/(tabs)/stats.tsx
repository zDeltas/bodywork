...
import { subMonths, format, parseISO, differenceInDays, startOfMonth, endOfMonth, addDays, getWeek, getYear, startOfWeek, endOfWeek } from 'date-fns';
      ...
      <View style={styles.content}>
        ...
        <Animated.View 
          style={[
            ...
            { opacity: fadeAnim, transform: [{ translateY: slideAnim.interpolate({ inputRange: [0, 1], outputRange: [50, 0] }) }] }
          ]}
        >
          <Text style={styles.chartTitle}>Statistiques globales</Text>
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              ...
              >
                <Ionicons name="barbell-outline" size={24} color="#fff" style={styles.statIcon} />
          ...
          <View style={styles.statsGrid}>
            <View style={styles.statCard}>
              <LinearGradient
                ...
                style={styles.statGradient}
              >
                <Ionicons name="trophy-outline" size={24} color="#fff" style={styles.statIcon} />
            ...
            <View style={styles.statCard}>
              <LinearGradient
                ...
                style={styles.statGradient}
              >
                <Ionicons name="repeat-outline" size={24} color="#fff" style={styles.statIcon} />
