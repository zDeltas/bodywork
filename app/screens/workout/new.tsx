    ...
    <View style={styles.container} onLayout={onLayoutRootView}>
      ...
      <ScrollView style={styles.content} contentContainerStyle={{ paddingBottom: 100 }}>
          ...
          <View key={index} style={styles.seriesContainer}>
            ...
            <View style={styles.rpeSectionContainer}>
              <View style={styles.sectionTitleContainer}>
                ...
                <Text
                  style={[styles.seriesInputLabel, item.type === 'warmUp' && styles.disabledLabel]}
                >
                  {t('workout.rpe')}
                  {item.type === 'warmUp' && (
                    <Text variant="caption" style={styles.disabledLabelNote}>
                      {' '}
                      ({t('workout.notApplicable')})
                    </Text>
                  )}
                </Text>
              </View>
              {item.type === 'warmUp' ? (
                <View style={[styles.rpeButtonGrid, styles.disabledDropdown]}>
                  <Text variant="body" style={styles.disabledDropdownButtonText}>
                    {t('workout.notApplicable')}
                  </Text>
                </View>
              ) : (
            ...
            {index > 0 && (
              <View style={styles.quickFillContainer}>
                ...
                >
                  <Text variant="body" style={styles.quickFillButtonText}>
                    {t('workout.usePreviousValues')}
                  </Text>
                </TouchableOpacity>
              </View>
            )}
        ...
        {!isAnyRpeDropdownOpen && series.length > 0 && (
          ...
          >
            <Text variant="body" style={styles.duplicateButtonText}>
              {t('workout.duplicateLastSeries')}
            </Text>
          </TouchableOpacity>
        )}
        ...
        {!isAnyRpeDropdownOpen && (
          ...
          >
            ...
            />
            <Text variant="body" style={styles.addSeriesButtonText}>
              {t('workout.addSeries')}
            </Text>
          </TouchableOpacity>
        )}
